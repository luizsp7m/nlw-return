  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-md my-1">Agradecemos o feedback</span>

        <button
          onClick={onFeedbackRestartRequested}
          type="button"
          className="text-slate-50 py-2 px-6 mt-6 bg-sky-400 rounded-md border-transparent text-sm leading-6 hover:bg-sky-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-sky-400"
        >
