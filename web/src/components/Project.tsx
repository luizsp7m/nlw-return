...
export function Project({ project }: Props) {
  return (
    <div className="relative overflow-hidden rounded-xl group w-full">
      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 bg-black bg-opacity-20 p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100 cursor-pointer">
